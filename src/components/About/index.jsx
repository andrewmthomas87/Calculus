...
class About extends Component {
	...
	constructor(props) {
		...
		this.pages = [
			...
			<p><span>Linear equations</span> that pass through the origin (no c value) will have the same computed area using a <span>Middle</span> Riemann Sum calculation regardless of the number of intervals. For example, using the equation <span>15.4x</span> on the interval <span>[3.5, 7.333]</span>, the area is <span>319.7262</span> using <span>1</span>, <span>1000</span>, or <span>any number</span> of intervals.<br /><br />Any <span>quadratic function</span> with <span>one term</span> looks the same for any positive number <span>n</span> on the interval <span>[0, n]</span>. For example, the equation <span>2.5x^3</span> looks the same on the intervals <span>[0, 0.00001]</span> and <span>[0, 9382.283]</span>.</p>,
